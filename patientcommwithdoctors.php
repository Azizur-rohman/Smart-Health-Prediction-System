...
<head>
 ...
 @import "css/patientcommwithdoctorsmodify1.css";
...
?>
 ...
 <div class="details1-panel-container">
  ...
  <b class="name1">Gender:</b> <b class="fatchname1"><?php print_r($gender); ?></b><br>
        ...
        <a class="active" id="dropbtn1">Communication
        <i class="fa fa-caret-down"></i>
        </a>
        <div class="dropdown-content1">
        <a href="patientalldoctorsinfo.php" >All Doctors Info</a>
        <a class="active" href="patientcommwithdoctors.php">Communicate with doctors</a>
        </div>
        </li>
        ...
        <div class="profile-container">
            ...
            <div class="setting-model">
                ...
                <div class="setting-model-logout">
                    ...
                    <a href="patientlogout.php"><p>Logout</p></a>
        ...
        <div class="user-container">
             ...
             <div class="search-container">
                 ...
                 <div class="search-user text">
                     ...
                     <input type="text" id="search" name="user" placeholder="Search full name.." autocomplete="off"/> 
