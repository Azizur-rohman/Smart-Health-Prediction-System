...
?>
 ...
 <div class="details1-panel-container">
  ...
  <b class="name1">Gender:</b> <b class="fatchname1"><?php print_r($gender); ?></b><br>
        ...
        <li class="l"><a class="active" href="doctorfeedback.php">Feedback</a></li>
        <li class="l"><a href="doctorlogout.php">Logout</a></li>
      </ul>
    </nav>
  <div class="contact-form">
    <form method="Post"action="doctorfeedback.php" id="usrform" >
  <b style="color: darkorange;font-size: 29px">Title: </b><input type="text" class="input" name="Title" placeholder="Enter Your Title" autocomplete="off" required>
...
$dbname = "Your databasename";
    ...
    $conn = new mysqli($host,$dbUsername, $dbPassword, $dbname);
$email = $_SESSION['Email'];
$query = "SELECT `doctor_id`,`FirstName`, `LastName`, `Email`, `user_password`, `phoneCode`, `phone`, `gender`, `File` FROM register WHERE Email = '$email'";
$result = $conn->query($query);
...
@$comment = $_POST['comment'];
   ...
   if (mysqli_connect_error()) {
     ...
     $INSERT = "INSERT Into comment (Title,comment,doctor_id) values(?, ?, ?)";
     //Prepare statement
     ...
     if ($rnum==0) {
      ...
      window.location.href='doctorfeedback.php'
       </script>");
     } else {
...
<script>
 ...
 var _0x221d=["\x2E\x70\x72\x6F\x66\x69\x6C\x65\x2D\x62\x74\x6E","\x71\x75\x65\x72\x79\x53\x65\x6C\x65\x63\x74\x6F\x72","\x23\x63\x6C\x6F\x73\x65\x64\x65\x74\x61\x69\x6C\x73","\x2E\x64\x65\x74\x61\x69\x6C\x73\x31\x2D\x70\x61\x6E\x65\x6C\x2D\x63\x6F\x6E\x74\x61\x69\x6E\x65\x72","\x63\x6C\x69\x63\x6B","\x76\x69\x73\x69\x62\x6C\x65","\x74\x6F\x67\x67\x6C\x65","\x63\x6C\x61\x73\x73\x4C\x69\x73\x74","\x61\x64\x64\x45\x76\x65\x6E\x74\x4C\x69\x73\x74\x65\x6E\x65\x72","\x72\x65\x6D\x6F\x76\x65","\x2E\x66\x6C\x6F\x61\x74\x69\x6E\x67\x2D\x62\x74\x6E","\x2E\x63\x6C\x6F\x73\x65\x2D\x62\x74\x6E","\x2E\x73\x6F\x63\x69\x61\x6C\x2D\x70\x61\x6E\x65\x6C\x2D\x63\x6F\x6E\x74\x61\x69\x6E\x65\x72","\x6D\x73\x67","\x67\x65\x74\x45\x6C\x65\x6D\x65\x6E\x74\x42\x79\x49\x64","\x76\x61\x6C\x75\x65","\x69\x6E\x6E\x65\x72\x48\x54\x4D\x4C","\x63\x6F\x75\x6E\x74\x65\x72","\x6C\x65\x6E\x67\x74\x68","\x63\x6F\x6C\x6F\x72","\x73\x74\x79\x6C\x65","\x62\x6C\x61\x63\x6B","\x72\x65\x64","\x73\x6C\x69\x63\x65"];const profile_btn=document[_0x221d[1]](_0x221d[0]);const closedetails_btn=document[_0x221d[1]](_0x221d[2]);const details1_panel_container=document[_0x221d[1]](_0x221d[3]);profile_btn[_0x221d[8]](_0x221d[4],()=>{details1_panel_container[_0x221d[7]][_0x221d[6]](_0x221d[5])});closedetails_btn[_0x221d[8]](_0x221d[4],()=>{details1_panel_container[_0x221d[7]][_0x221d[9]](_0x221d[5])});const floating_btn=document[_0x221d[1]](_0x221d[10]);const close_btn=document[_0x221d[1]](_0x221d[11]);const social_panel_container=document[_0x221d[1]](_0x221d[12]);floating_btn[_0x221d[8]](_0x221d[4],()=>{social_panel_container[_0x221d[7]][_0x221d[6]](_0x221d[5])});close_btn[_0x221d[8]](_0x221d[4],()=>{social_panel_container[_0x221d[7]][_0x221d[9]](_0x221d[5])});setInterval(function(){message= document[_0x221d[14]](_0x221d[13]);text= message[_0x221d[15]];document[_0x221d[14]](_0x221d[17])[_0x221d[16]]= text[_0x221d[18]];if(text[_0x221d[18]]<= 190){document[_0x221d[14]](_0x221d[17])[_0x221d[20]][_0x221d[19]]= _0x221d[21]};if(text[_0x221d[18]]> 190){document[_0x221d[14]](_0x221d[17])[_0x221d[20]][_0x221d[19]]= _0x221d[22]};if(text[_0x221d[18]]> 200){newtext= text[_0x221d[23]](0,200);message[_0x221d[15]]= newtext}},100)
