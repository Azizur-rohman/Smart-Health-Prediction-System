...
@import "css/adminpatientcomment.css";
...
<body>
 ...
 <nav>
      ...
      <ul>
        ...
        <a class="active" href="adminpatientcomment.php" >Patients Comment</a>
  ...
  <table class=" table-hover " border="1">
      <tr>
          <th style="text-align: center;background-image:linear-gradient(to left,#FEB69A,#C70039,#FEB69A);color:white" colspan="5">All Patients Comment</th>
      </tr>
...
$sql = "SELECT id,Title,comment,Patient_id,Date_and_Time FROM comment ";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    <tr>
      ...
      <td style="text-align: center;"><?php print_r($Patient_id); ?></td>
